...
async function setCardsField(cardId){
    ...
    /**sorteia uma carta aleatoria para o computador */
...
//    state.fieldCards.computer.src = cardData[computerCardId].img;
    ...
    /**checa os resultados comparando o id de um carta com outra */
    let duelResults = await checkDuelResults(cardId, computerCardId);

    /**atualizar pontuação */
    await updateScore();
    /**desenhar meu botao de acordo com drawResults, se perdeu ou ganhou */
